...
public class MovieLoopPoster extends AppCompatActivity implements DiscreteScrollView.OnItemChangedListener,
    ...
    public void touch_at(int item_num) {
        ClearActivityTest.init_pos(MovieLoopPoster.this, item_num);
    }
